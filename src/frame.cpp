...
namespace myslam{
    ...
    Frame::Frame(long id, double time_stamp, Sophus::SE3 T_c_w, Camera::Ptr camera, Mat color, Mat depth)
    ...
    double Frame::findDepth(const cv::KeyPoint &kp) {
        ...
        ushort d = depth_.ptr<ushort>(y)[x]; // y,then x!

        if(d !=0) // have a deep infomation
        {
